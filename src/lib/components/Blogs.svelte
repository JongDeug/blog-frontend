<script lang="ts">
	import { Title, formatDate, SearchBox, Category, CategoryModal } from '$lib';
			...
			{#if isLogin}
				<p class="text-right">
					...
					<input
						...
						id="draft"
						bind:checked={draft}
						class="form-checkbox ml-2 h-5 w-5 bg-gray-200 text-blue-600 transition duration-150 ease-in-out dark:bg-gray-700"
					/>
				</p>
			{/if}
			<p>No post found.</p>
